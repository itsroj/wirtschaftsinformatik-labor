      ...
      <form class="form" @submit.prevent="submit">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input v-model="form.longTitle" type="text"
              placeholder="z.B. Berlin Model United Nations 2025" :disabled="loading" />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea v-model="form.description_de" rows="4"
            placeholder="Kurze deutsche Beschreibung der Konferenz..." :disabled="loading"></textarea>
        </div>

        <div class="form-group">
          <label>Description (English)</label>
          <textarea v-model="form.description_en" rows="4"
            placeholder="Short English description of the conference..." :disabled="loading"></textarea>
        </div>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input v-model="form.participants" type="number" min="1"
              placeholder="z.B. 200" :disabled="loading" />
          </div>
          <div class="form-group">
            <label>Erste Konferenz (Jahr) *</label>
            <input v-model="form.firstConference" type="number" min="1900" max="2100"
              placeholder="z.B. 2015" :disabled="loading" />
          </div>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input v-model="form.instagramLink" type="url"
              placeholder="https://instagram.com/..." :disabled="loading" />
          </div>
          <div class="form-group">
            <label>Facebook</label>
            <input v-model="form.facebookLink" type="url"
              placeholder="https://facebook.com/..." :disabled="loading" />
          </div>
        </div>
